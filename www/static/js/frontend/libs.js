...
AnimateElements.prototype.scroll = function () {
    ...
    document.querySelectorAll(this._selector).forEach(function (element, index) {
        window.addEventListener("scroll", function () {
            ...
            if ((document.documentElement.scrollTop || document.body.scrollTop) >= element_pos - self._space_before && (document.documentElement.scrollTop || document.body.scrollTop) <= element_pos + self._space_after) {
                //console.log("s");
 ...
 * @private
 */
AnimateElements.prototype._swapClasses = function (item, func) {
...
function goSlider() {
    ...
    var slides = document.querySelectorAll(".slide"),
        //an arr with all slides
    prev_slide = document.querySelector("#prev_slide"),
        //prev_slide btn
    next_slide = document.querySelector("#next_slide"),
        //next_slide btn
    cnt = 0,
        //count every step in slider
    ...
    function minus_slide(e) {
        ...
        if (cnt == 0) {
            ...
            for (var i = 0; i < slides.length - num_of_slides; ++i) {
